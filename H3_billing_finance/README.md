# 📁 พื้นที่ส่งงาน: H3: ระบบการเงินและบัญชี (Billing & Finance)
**ผู้รับผิดชอบ:** นิธิศ (สมาชิก H3)  
**ขอบเขตข้อมูลหลัก:** ใบแจ้งหนี้ รายการค่าใช้จ่าย การชำระเงิน (เชื่อมต่อ H1, H2, H4, H5, H6)  
