...
| :---: | :--- | :--- | :---: | :---: |
| **H1** | **ทะเบียนผู้ป่วย (Patient Registration)** | ผู้ป่วย, ที่อยู่/ช่องทางติดต่อ, สิทธิการรักษา | **นายอภิสิทธิ์ ศรีพัฒน์ (6811011662010)** | ✅ เสร็จสมบูรณ์ (Base) |
| **H2** | **นัดหมาย/OPD (Appointments & OPD)** | นัดหมาย, การเข้ารับบริการ, การตรวจรักษา | สมาชิก H2 | 🔄 Ready for Integration |
| **H3** | **การเงิน (Billing & Accounts)** | ใบแจ้งหนี้, รายการค่าใช้จ่าย, การชำระเงิน | สมาชิก H3 | 🔄 Ready for Integration |
...
| **H6** | **ผู้ป่วยใน/วอร์ด (Inpatient & Wards)** | Admit, เตียง, วอร์ด, การย้าย, การจำหน่าย | สมาชิก H6 | 🔄 Ready for Integration |
| **H7** | **บุคลากร (Staff & Personnel)** | แพทย์, พยาบาล, เภสัชกร, เจ้าหน้าที่ | สมาชิก H7 | 🔄 Ready for Integration |
